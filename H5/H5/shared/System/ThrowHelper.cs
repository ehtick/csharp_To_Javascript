...
namespace System
{
    ...
    internal static class ThrowHelper
    {
        ...
        private static ArgumentException GetWrongKeyTypeArgumentException(object key, Type targetType)
        {
            ...
            return new ArgumentException(SR.Format("The value \"{0}\" is not of type \"{1}\" and cannot be used in this generic collection.", key, targetType), nameof(key));
        }
        ...
        private static ArgumentException GetWrongValueTypeArgumentException(object value, Type targetType)
        {
            ...
            return new ArgumentException(SR.Format("The value \"{0}\" is not of type \"{1}\" and cannot be used in this generic collection.", value, targetType), nameof(value));
        }
        ...
        private static KeyNotFoundException GetKeyNotFoundException(object key)
        {
            ...
            return new KeyNotFoundException(SR.Format("The given key '{0}' was not present in the dictionary.", key.ToString()));
        }
